package mediator_test.tests {
	 ...
	 * @author phihey
	 */
	public class ControlBarMediatorTest {
		private var _instanceMediator : ControlBarMediator;

		[Before]
		public function setup():void {
			_instanceMediator = new ControlBarMediator();
			_instanceMediator.view = new ControlBar();
		...
		public function testInstantiated():void {
			assertTrue("instanceMediator is ControlBarMediator", _instanceMediator is ControlBarMediator);
		}
